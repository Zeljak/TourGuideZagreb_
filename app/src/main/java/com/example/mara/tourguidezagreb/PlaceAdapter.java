...
public class PlaceAdapter extends ArrayAdapter<Place> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the list_item.xml layout with the ID zagreb_text_view.
        TextView zagrebTextView = (TextView) listItemView.findViewById(R.id.zagreb_text_view);
        // Get the info from the current Place object and set this text on
        // the Zagreb TextView.
        zagrebTextView.setText(currentPlace.getPlaceName());
